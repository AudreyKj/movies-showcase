...
import {
  render, screen, cleanup, within, fireEvent,
...
describe('a carousel component that displays a scrollable list of images', () => {
  afterEach(() => {
    cleanup();
  });

  it('displays a scrollable list', async () => {
  ...
  it('on click, each carousel item navigates to its detail page', async () => {
